package com.example.postrequestpractice2
...
class AddItem : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name = findViewById<View>(R.id.edtxtName) as EditText
        val location = findViewById<View>(R.id.edtxtLocation) as EditText
        val savebtn = findViewById<View>(R.id.btnSave) as Button
    ...
    private fun addSingleuser(f: Users.UserDetails, onResult: () -> Unit) {
        ...
        val progressDialog = ProgressDialog(this@AddItem)
